<?php
/**
Extension Name: CMB2 Conditionals
Contributors: jcchavezs
Fixed by: jrfnl
URL: https://github.com/jrfnl/cmb2-conditionals/tree/feature/fix-issue-2-group-conditionals
...
// add_action( 'plugins_loaded', 'cmb2_conditionals_load_actions' ); // Removed up in the main plugin file
...
function cmb2_conditionals_footer() {
	...
	if ( get_current_post_type() !== 'rh_specification' && get_current_post_type() !== 'rh_tabpost') {
		return;
	}
