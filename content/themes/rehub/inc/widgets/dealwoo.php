	...
	<?php endif; ?>
		...
		<?php while( $loop->have_posts() ) : $loop->the_post(); ?>
				<?php if ( 'product' == $dealtype && class_exists('woocommerce')):?>
					...
					<?php 	
						$target_blank = ( $product->product_type == 'external' ) ? ' target="_blank" rel="nofollow"' : '' ;
						$product_link = ( $product->product_type == 'external' ) ? $product->add_to_cart_url() : get_the_permalink( $post->ID );
					?>
