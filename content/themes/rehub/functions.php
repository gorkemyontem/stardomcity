...
function rehub_framework_register_scripts() {
	...
	// Stylesheets
	wp_register_style('rhstyle', get_stylesheet_directory_uri() . '/style.css', array(), '6.8.1');
	wp_register_style('responsive', get_template_directory_uri() . '/css/responsive.css', array(), '6.8.1');
	...
	wp_register_style( 'rehub-woocommerce', get_template_directory_uri().'/css/woocommerce.css', array(), '6.8.1', 'all' );
	...
	wp_register_style('eggrehub', get_template_directory_uri() . '/css/eggrehub.css', array(), '6.8.1');
	...
	wp_register_script('rehub', get_template_directory_uri() . '/js/custom.js', array('jquery'), '6.8.1', true);
...
function rehub_admin_error_notice() {
    ...
    if ( ! get_user_meta($user_id, 'ignore_notices_rehub68') ) {
		if ($page=='rehub' || $page=='rehub-support' || $page=='rehub-plugins' || $page=='rehub-demos' || $page=='vpt_option' ) {
			$class = "error";
			$message = 'Rehub 6.8 added AMP support. Check here some tutorials. Use only when you need it <a href="https://wpsoul.com/amp-wordpress-setup/" target="_blank">AMP tips</a>.' ;
...
function rehub_nag_ignore() {
    ...
    if ( isset($_GET['rehub_nag_ignore']) && '0' == $_GET['rehub_nag_ignore'] ) {
        add_user_meta($user_id, 'ignore_notices_rehub68', 'true', true);
