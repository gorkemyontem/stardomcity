                                ...
                                switch ($item['type'])
                                {
                                    case 'slider':
                                        ...
                                        <div class="mdf_input_container" <?php if ($this_item_is_hidden): ?>style="display: none;"<?php endif; ?>>
                                            <h5 class="data-filter-section-title" style="margin-bottom: 4px;"><?php _e($item['name']) ?>:&nbsp;<span class="mdf_range"><input type="text" value="<?php echo $min ?>" class="mdf_range_min" data-slider-id="ui_slider_item_<?php echo $uid ?>" />
                                    ...
                                    case 'select':
                                        ...
                                        if (!empty($item['select']))
                                        {
                                            ...
                                            <div class="mdf_input_container" <?php if ($this_item_is_hidden): ?>style="display: none;"<?php endif; ?>>
                                                ...
                                                <?php if ($item['name']{0} !== '~'): ?>
                                                    <h5 class="data-filter-section-title" style="margin-bottom: 4px;"><?php _e($item['name']) ?>:
                                    ...
                                    case 'textinput':
                                        ...
                                        <div class="mdf_input_container" <?php if ($this_item_is_hidden): ?>style="display: none;"<?php endif; ?>>
                                            <?php if ($item['name']{0} !== '~'): ?>
                                                <h5 class="data-filter-section-title"><?php if (!empty($item['name'])) _e($item['name'] . ':'); ?>
                                                    <?php if (!empty($item['description'])): ?>
                                                        <label for="<?php echo $meta_key ?>_<?php echo $uid ?>">
                                                            <span class="mdf_tooltip" title="<?php echo str_replace('"', "'", __($item['description'])); ?>">
                                                                <img src="<?php echo $icon ?>" alt="help" />
